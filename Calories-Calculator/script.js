...
const options = [ // อิ่มตัว | ไม่อิ่มตัว
    ...
    { text: 'ข้าวผัด', protein: 8, carbs: 27, fat: 8, energy: 180, amount: 100, unit: 'กรัม' }, // 2 | 6
    // { text: 'ผัดกะเพราหมู (กับข้าว)', protein: 26.4, carbs: 0, fat: 18.5, energy: 279, amount: 100, unit: 'กรัม' }, // 5.5 | 12.5
    ...
    { text: 'หมูทอด', protein: 20.2, carbs: 0.8, fat: 35.3, energy: 405, amount: 100, unit: 'กรัม' },
